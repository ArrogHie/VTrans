        ...
        ModelManifest {
            ...
            ocr: vtrans_models::OcrModelGroup {
                ...
                preprocess_params: vtrans_models::PreprocessParams {
                    ...
                    det_threshold: 0.5,
                    unclip_ratio: 1.5,
                    box_threshold: vtrans_models::DEFAULT_BOX_THRESHOLD,
                    max_candidates: vtrans_models::DEFAULT_MAX_CANDIDATES,
                    min_box_size: vtrans_models::DEFAULT_MIN_BOX_SIZE,
                    rec_input_height: vtrans_models::DEFAULT_REC_INPUT_HEIGHT,
                    rec_input_width: vtrans_models::DEFAULT_REC_INPUT_WIDTH,
                    rec_append_space: vtrans_models::DEFAULT_REC_APPEND_SPACE,
                    rec_blank_index: vtrans_models::DEFAULT_REC_BLANK_INDEX,
                },
            },
            translation,
        }
